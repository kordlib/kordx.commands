...
class ListArgumentTest {
    ...
    companion object {
        ...
        fun sources() = listOf(
                ...
                Arguments.of(",", "Three shall be the number thou shalt count, and the number of the counting shall be three.", listOf("Three shall be the number thou shalt count", " and the number of the counting shall be three.")),
