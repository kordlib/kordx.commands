...
import com.gitlab.kordlib.kordx.commands.argument.result.Result.Failure
import com.gitlab.kordlib.kordx.commands.argument.result.Result.Success
...
sealed class Result<T> {
    ...
    companion object {
         ...
         */
        fun <T : Any> notNull(item: T?, wordsTaken: Int, failure: () -> Failure<T>): Result<T> = when (item) {
            null -> failure()
