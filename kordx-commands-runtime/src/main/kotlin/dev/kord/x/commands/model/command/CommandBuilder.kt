...
import dev.kord.x.commands.internal.CommandsBuilder
import dev.kord.x.commands.model.exception.ConflictingAliasException
import dev.kord.x.commands.model.metadata.MutableMetadata
import dev.kord.x.commands.model.precondition.Precondition
import dev.kord.x.commands.model.precondition.precondition
import dev.kord.x.commands.model.processor.BuildEnvironment
...
class CommandBuilder<S, A, COMMANDCONTEXT : CommandEvent>(
     ...
     */
    var arguments: List<dev.kord.x.commands.argument.Argument<*, A>> = emptyList()
