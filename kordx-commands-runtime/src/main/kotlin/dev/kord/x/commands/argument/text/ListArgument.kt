 ...
 */
val ListArgument: dev.kord.x.commands.argument.Argument<List<String>, Any?> = InternalListArgument()
...
fun ListArgument(separator: String = "|"): dev.kord.x.commands.argument.Argument<List<String>, Any?> =
    InternalListArgument(separator)
