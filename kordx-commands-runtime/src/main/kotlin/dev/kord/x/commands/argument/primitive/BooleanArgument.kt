 ...
 */
val BooleanArgument: dev.kord.x.commands.argument.Argument<Boolean, Any?> =
    InternalBooleanArgument()
...
): dev.kord.x.commands.argument.Argument<Boolean, Any?> =
    InternalBooleanArgument(trueValue, falseValue, ignoreCase)
