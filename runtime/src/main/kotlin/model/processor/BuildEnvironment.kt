...
import dev.kord.x.commands.model.exception.DuplicateCommandNameException
import dev.kord.x.commands.model.exception.DuplicateModuleNameException
...
data class BuildEnvironment(
    ...
    fun addModule(module: Module) {
        if (modules.containsKey(module.name)) throw DuplicateModuleNameException(
            modules[module.name]!!,
            module
        )
    ...
    fun addCommand(command: Command<*>) {
        if (commands.containsKey(command.name)) throw DuplicateCommandNameException(
