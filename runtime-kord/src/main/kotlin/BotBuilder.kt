package dev.kord.x.commands.kord

import dev.kord.core.Kord
import dev.kord.x.commands.kord.model.processor.*
import dev.kord.x.commands.kord.plug.KordPlugSocket
...
class BotBuilder(
    ...
    suspend fun build(): CommandProcessor = processorBuilder.apply {
        ...
        if (eventHandlers[KordContext] == null && eventHandlers[CommonContext] == null) {
            eventHandlers[KordContext] =
                BaseEventHandler(KordContext, KordContextConverter, KordErrorHandler())
        }
