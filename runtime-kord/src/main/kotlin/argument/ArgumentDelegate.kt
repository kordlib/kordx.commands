 ...
 */
fun <T> argumentDelegate(delegate: suspend KordEvent.() -> ArgumentResult<T>): ArgumentDelegate<T> =
    delegate
...
private class DelegateArgument<T>(
    ...
    override suspend fun parse(
        ...
        return argument.parse(text, fromIndex, context)
            .switchOnFail { delegate(KordEvent(context)) }
    }
