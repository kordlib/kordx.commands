 ...
 */
inline fun PrefixBuilder.kord(supplier: () -> PrefixRule<KordEventAdapter>) = add(KordContext, supplier())

/**
 * Sets the [supplier] as the prefix for the [KordContext].
 */
fun PrefixBuilder.kord(supplier: PrefixRule<KordEventAdapter>) = add(KordContext, supplier)
