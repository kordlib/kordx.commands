...
/**
 * Defines a [Precondition] for Kord commands. Any [KordCommandEvent] that doesn't match the [filter] will not be invoked.
 *
 * Note that preconditions run *before* arguments get parsed, a [KordCommandEvent] that passed a precondition is therefore
